...
class PassCodeScreen extends StatelessWidget {
        ...
        body: SafeArea(
          child: BlocProvider<PinCodeCubit>(
            create: (BuildContext context) =>
                PinCodeCubit(context.repository<SessionRepository>()),
                ...
                if (value == true) {
                  switch (status) {
                    case PassCodeStatus.signInCreate:
                      context
                          .read<SessionCubit>()
                          .sessionVerificationSuccessEvent();
                      showBiometricChoosePopup(
                        context,
                        () {
                          context
                              .read<BiometricCubit>()
                              .biometricSkipEvent(true);
                  ...
                  if (status == PassCodeStatus.verification ||
                    ...
                    if (failedAttempts >= _max_attempts) {
                      ...
                      showAlertDialog(
                        ...
                        description:
                            "${AppStrings.NUMBER_ATTEMPTS.tr()} ${_max_attempts - failedAttempts}",
                        onPress: () => Get.back(),
                      );
                    }
                  }
  ...
  void showBiometricChoosePopup(
      BuildContext context, GestureTapCallback onTap, bool isSignUp) async {
