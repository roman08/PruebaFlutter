...
class PaymentsMethod extends StatelessWidget {
  ...
  final _PaymentsMethodStyle _style =
      _PaymentsMethodStyle.fromOldTheme(AppThemeOld.defaultTheme());
  ...
  Widget _paymentTile(
      {String title, String icon, GestureTapCallback onPress, bool isEnable}) {
    return Padding(
