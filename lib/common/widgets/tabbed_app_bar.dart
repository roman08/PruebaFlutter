...
class TabbedAppBar extends StatelessWidget {
  ...
  final _TabbedAppBarStyle style =
      _TabbedAppBarStyle.fromOldTheme(AppThemeOld.defaultTheme());
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          appBar: PreferredSize(
              preferredSize:
                  Size.fromHeight(110 + bottomBar.preferredSize.height),
              child: AppBar(
  ...
  PreferredSize _bottomBar(BuildContext context) {
    ...
    return PreferredSize(
      ...
      child: Column(
        children: <Widget>[
          TabBar(
            indicatorColor: style.colors.primaryBlue,
            unselectedLabelColor: style.colors.boldShade,
            labelStyle: style.tabLabelTextStyle,
            labelColor: style.colors.primaryBlue,
            indicatorWeight: 1,
            isScrollable: true,
            ...
            tabs: choices.map((TabBarChoice choice) {
              return Container(
                  width: tabWidth, child: Tab(text: choice.title.tr()));
            }).toList(),
            onTap: (position) => {
              context.read<TransactionHistoryCubit>().updateOperationEvent(
                  RequestEnums.intAsRequestOperation(position)),
            },
          ),
          Divider(
