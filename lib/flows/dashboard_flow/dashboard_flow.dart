...
const List<Destination> _allDestinations = <Destination>[
  Destination(AppStrings.OVERVIEW, IconsSVG.tabBarHome, Navigation.overview),
  Destination(
      AppStrings.PAYMENTS, IconsSVG.tabBarPayments, Navigation.payments),
  Destination(
      AppStrings.TRANSACTIONS, IconsSVG.tabBarHistory, Navigation.transactions),
  Destination(
      AppStrings.NOTIFICATIONS, IconsSVG.tabBarBell, Navigation.notifications),
...
class DashboardFlow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final itemTextSelectedStyle =
        theme.textStyles.m10.copyWith(color: theme.colors.primaryBlue);
    final itemTextStyle =
        theme.textStyles.m10.copyWith(color: theme.colors.boldShade);
            ...
            bottomNavigationBar: CupertinoTabBar(
              ...
              onTap: (int index) {
                context
                    ...
                    .navigateTo(Navigation.values[index]);
              },
              items: _allDestinations.map((Destination destination) {
                return BottomNavigationBarItem(
                  ...
                  title: Text(
                    ...
                    style: state.navigation == destination.navigation
  ...
  Future<void> _parseNotification(BuildContext context,
      Map<dynamic, dynamic> message, bool showDialog) async {
    logger.i(message);
