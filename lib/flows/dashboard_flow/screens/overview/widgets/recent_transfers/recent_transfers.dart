...
class RecentTransfersStyle {
  ...
  RecentTransfersStyle(
      {this.titleTextStyle, this.shadow, this.allButtonStyle, this.itemStyle});
    ...
    return Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            margin:
                const EdgeInsets.only(left: 16, bottom: 0, top: 24, right: 16),
...
class RecentTransferStyle {
  ...
  RecentTransferStyle(
      {this.titleTextStyle, this.descriptionTextStyle, this.shapeColor});
          ...
          Row(
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    color: style.shapeColor, shape: BoxShape.circle),
