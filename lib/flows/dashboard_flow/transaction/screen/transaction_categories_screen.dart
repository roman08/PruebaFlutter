...
const List<_Choice> _choices = <_Choice>[
  ...
  _Choice(
      category: RequestCategory.request_money, title: AppStrings.REQUEST_MONEY),
...
class TransactionCategoriesScreen extends StatefulWidget {
  ...
  @override
  _TransactionCategoriesState createState() =>
      _TransactionCategoriesState(selectedCategory: _selectedCategory);
}
...
class _TransactionCategoriesState extends State<TransactionCategoriesScreen> {
  ...
  final _TransactionCategoriesScreenStyle style =
      _TransactionCategoriesScreenStyle.fromOldTheme(
    ...
    if (isSelected) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(width: 1, color: style.colors.lightShade)),
      );
    }
  }
}
