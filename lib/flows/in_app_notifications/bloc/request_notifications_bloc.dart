...
class RequestNotificationsBloc {
  ...
  final BehaviorSubject<List<RequestNotificationEntity>> requestNotifications =
      BehaviorSubject();
  final BehaviorSubject<RequestNotificationDetails> detailsNotification =
      BehaviorSubject();
