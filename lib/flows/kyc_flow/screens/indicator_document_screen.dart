...
class IndicatorDocumentScreenStyle {
  ...
  factory IndicatorDocumentScreenStyle.fromOldTheme(AppThemeOld theme) {
    return IndicatorDocumentScreenStyle(
      ...
      cancelActionSheetButtonStyle:
          theme.textStyles.m20.copyWith(color: theme.colors.primaryBlue),
      buttonBackgroundColor: theme.colors.primaryBlue,
    );
  }
}
...
class IndicatorDocumentScreen extends StatefulWidget {
  ...
  @override
  _IndicatorDocumentScreenState createState() =>
      _IndicatorDocumentScreenState();
}
...
class _IndicatorDocumentScreenState extends State<IndicatorDocumentScreen> {
  ...
  void initState() {
    ...
    final options = this
        ...
        .options
        .where((element) =>
            element.value == this.widget.requirement.elements[0].value)
        .toList();
    ...
    if (options.isNotEmpty) {
      final index = this
          ...
          .elements[0]
          .options
          .indexWhere((element) => element.value == options.first.value);
      setState(() {
  ...
  Widget saveButton(BuildContext context) {
    return CupertinoButton(
      ...
      onPressed: () {
        if ((_imagePath == null &&
                this.widget.requirement.elements[2].value == null) ||
            _selectedIndex == -1 ||
              ...
              requirement: RequirementRequest(
                values: [
                  ...
                  ElementValue(
                    ...
                    value:
                        _imagePath ?? this.widget.requirement.elements[2].value,
                  ),
                ],
              ),
            );
