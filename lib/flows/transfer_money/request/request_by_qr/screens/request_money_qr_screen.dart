...
class RequestMoneyByQrScreen extends StatelessWidget {
  ...
  final _RequestMoneyScreenStyle style =
      _RequestMoneyScreenStyle.fromOldTheme(AppThemeOld.defaultTheme());
          ...
          builder: (_, state) {
            if (state is RequestMoneyInitState) {
              ...
              return MultiBlocProvider(
                providers: [
                  BlocProvider(
                      create: (BuildContext context) => QrRequestFormCubit()),
                          ...
                          children: <Widget>[
                            ...
                            Button(
                              onPressed: state is CompletedState
                                  ? () => {
                                        Get.to(RequestMoneyGenerateQrScreen(
                                            state.recipientQREntity))
                                      }
                                  : null,
