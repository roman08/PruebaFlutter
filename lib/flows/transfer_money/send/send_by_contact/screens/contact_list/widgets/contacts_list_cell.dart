...
class ContactsListCell extends StatelessWidget {
  ...
  void _openContactDetails(BuildContext context) {
    ...
    final String currentUserPhone =
        context.read<SessionRepository>().userData.value.phoneNumber;

    if (form.notification.phoneNumber
            .replaceAll(" ", "")
            .replaceAll("(", "")
            .replaceAll(")", "")
            .replaceAll("-", "") ==
  ...
  void _showNonAppContactDialog(BuildContext context) {
    final bodyText = contactsListBLoC.flowType == ContactFlowType.send
        ? AppStrings.CANT_SENT_MONEY
        : AppStrings.CANT_REQUEST_MONEY;
